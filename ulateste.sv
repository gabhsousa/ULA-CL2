module ulateste (
    input [5:0] OperandoA,      // Renomeei A para OperandoA
    input [5:0] OperandoB,      // Renomeei B para OperandoB
    input Reset,                // Sinal de reset
    input Modo,                 // Sinal de modo (0: aritmético, 1: lógico)
    input [2:0] Operacao,       // Sinal de operação
    output reg [5:0] Resultado, // Renomeei O para Resultado
